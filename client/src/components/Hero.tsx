...
const Hero = () => {
  return (
    <section id="hero" className="relative py-24 px-6 lg:px-8 bg-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        >
          <Button onClick={() => { window.location.href="#scraper"}} className="bg-blue-600 hover:bg-blue-700 text-white shadow-xl transition-all duration-300 hover:scale-105 px-6 py-3 flex items-center">
