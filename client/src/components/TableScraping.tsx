          ...
          <div className="flex flex-col md:flex-row gap-4 w-full">
            ...
            <Select value={location} onValueChange={setLocation}>
              ...
              <SelectContent>
                ...
                <SelectItem value="united states" className="flex items-center gap-2">
                  <img src="/flags/us.png" alt="United States" className="w-10 h-5 rounded-sm" />
                  United States
                </SelectItem>
                <SelectItem value="canada" className="flex items-center gap-2">
                  <img src="/flags/canada.png" alt="Canada" className="w-10 h-5 rounded-sm" />
                  Canada
                </SelectItem>
                <SelectItem value="united kingdom" className="flex items-center gap-2">
                  <img src="/flags/uk.png" alt="United Kingdom" className="w-10 h-5 rounded-sm" />
                  United Kingdom
                </SelectItem>
                <SelectItem value="france" className="flex items-center gap-2">
                  <img src="/flags/france.png" alt="France" className="w-10 h-5 rounded-sm" />
                  France
                </SelectItem>
              </SelectContent>
            </Select>
              ...
              <Table>
                <TableHeader>
                  <tr>
                    ...
                    {enriched && <TableCell>LinkedIn</TableCell>}
                    {enriched && <TableCell>Current Employees</TableCell>}
                  </tr>
                </TableHeader>
                <TableBody>
                  {filteredCompanies.map((c) => (
                    ...
                    >
                      ...
                      <TableCell className="text-blue-500"><a href={c.website} target="_blank" rel="noopener noreferrer">{c.website}</a></TableCell>
                      {enriched && <TableCell>{c.linkedin || "n/a"}</TableCell>}
                      {enriched && <TableCell>{c.currentemployees ?? "n/a"}</TableCell>}
                    </tr>
                  ))}
                </TableBody>
              </Table>
